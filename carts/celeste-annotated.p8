...
function title_screen()
  ...
  frames=0 -- init the frame counter that gets updated in _update
  deaths=0 -- init our death count
  max_djump=1 -- sets the initial air-dash limit at 1 
...
function load_room(x,y)
  ...
  for rx=0,15 do
    for ry=0,15 do
      ...
      if tile==11 then init_object(platform,rx*8,ry*8).dir=-1
      elseif tile==12 then init_object(platform,rx*8,ry*8).dir=1
